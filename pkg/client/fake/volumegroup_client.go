...
func (v VolumeGroup) CreateVolumeGroup(name string, secrets, parameters map[string]string, volumeIds []string) (*csi.CreateVolumeGroupResponse, error) {
	return v.CreateVolumeGroupMock(name, secrets, parameters, volumeIds)
}
...
func (v VolumeGroup) ModifyVolumeGroupMembership(volumeGroupId string, volumeIds []string, secrets map[string]string, parameters map[string]string) (*csi.ModifyVolumeGroupMembershipResponse, error) {
	return v.ModifyVolumeGroupMembershipMock(volumeGroupId, volumeIds, secrets, parameters)
}
