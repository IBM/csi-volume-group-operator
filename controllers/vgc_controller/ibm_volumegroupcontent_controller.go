...
type IBMVolumeGroupContentReconciler struct {
	client.Client
	Log          logr.Logger
...
func (r *IBMVolumeGroupContentReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *IBMVolumeGroupContentReconciler) SetupWithManager(mgr ctrl.Manager, cfg *config.DriverConfig) error {
